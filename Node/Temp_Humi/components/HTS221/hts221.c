...
static void i2c_hts221_bus_init(void)
{
    i2c_config_t conf;
    conf.mode = I2C_MODE_MASTER;
    conf.sda_io_num = (gpio_num_t)I2C_HTS221_SDA_IO;
    conf.sda_pullup_en = GPIO_PULLUP_ENABLE;
    conf.scl_io_num = (gpio_num_t)I2C_HTS221_SCL_IO;
    conf.scl_pullup_en = GPIO_PULLUP_ENABLE;
    conf.master.clk_speed = I2C_HTS221_FREQ_HZ;
    conf.clk_flags = I2C_SCLK_SRC_FLAG_FOR_NOMAL;
    ESP_ERROR_CHECK(i2c_param_config(I2C_HTS221_NUM, &conf));
    ESP_ERROR_CHECK(i2c_driver_install(I2C_HTS221_NUM, conf.mode, 0, 0, 0));
}

hts221_handle_t i2c_sensor_hts221_init(void)
{
    i2c_hts221_bus_init();
    hts221_handle_t hts221 = hts221_create(I2C_HTS221_NUM);
    return hts221;
}
